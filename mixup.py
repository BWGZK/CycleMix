...
cost_matrix_dict = {'2':cost_matrix(2, device).unsqueeze(0), '4':cost_matrix(4, device).unsqueeze(0), '8':cost_matrix(8, device).unsqueeze(0), '16':cost_matrix(16, device).unsqueeze(0),'32':cost_matrix(32, device).unsqueeze(0),'64':cost_matrix(64, device).unsqueeze(0)}
